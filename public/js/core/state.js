(function initCorsicaState(global) {
  const state = {
    ...
    bankroll: 1000,
    totalWins: 0,
    jackpots: { bronze: 200, argent: 750, or: 2500, diamant: 10000 },
  ...
  function resetRoundState() {
    ...
    state.board = [];
    state.hands = [];
    state.jackpotBets = { bronze: [], argent: [], or: [], diamant: [] };
    ...
    state.jackpotRoundStake = { bronze: 0, argent: 0, or: 0, diamant: 0 };
